...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Slogan_tip", "Property of CyberTech Consultants"),
        ...
        ("printer-requires-installed-{}-client-tip", "In order to use remote printing, CyberDesk needs to be installed on this device."),
